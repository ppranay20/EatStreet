...
const Footer = () => {
  ...
  <div className='w-full px-36 py-20 bg-[#323232] text-white flex items-center justify-between'>
      <div className='w-[540px] flex flex-col gap-9'>
        <img src={mainlogo} className='w-28' />
        <p className='text-sm text-gray-200'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ex eveniet porro corrupti. Ducimus dolorem temporibus nobis modi ratione facere incidunt eligendi, aut omnis voluptatem illum!</p>
    ...
    <hr className='p-6 w-[1100px] m-auto' />
    <p className='w-[550px] m-auto text-white text-sm text-center py-2'>Copyright 2024 © Tomato.com - All Rights Reserved.</p>
  </div>
